...
// Реальні сузір'я з правильними з'єднаннями зірок
const constellationLines = ref([
  // 1. Велика Ведмедиця (Ursa Major / Великий Віз) - ківш з 7 зірок
  { x1: 10, y1: 15, x2: 14, y2: 18 },   // дно ковша: перша-друга зірка
  { x1: 14, y1: 18, x2: 20, y2: 17 },   // друга-третя зірка
  { x1: 20, y1: 17, x2: 24, y2: 19 },   // третя-четверта зірка
  { x1: 24, y1: 19, x2: 28, y2: 21 },   // четверта-п'ята зірка (ручка)
  { x1: 28, y1: 21, x2: 22, y2: 25 },   // п'ята-шоста зірка (ручка)
  { x1: 22, y1: 25, x2: 18, y2: 23 },   // шоста-сьома зірка (ручка)
  { x1: 18, y1: 23, x2: 14, y2: 18 },   // сьома-друга (замикає ківш)
  { x1: 20, y1: 17, x2: 22, y2: 25 },   // третя-шоста (діагональ ковша)
  
  // 2. Оріон - найвідоміше зимове сузір'я з поясом з 3 зірок
  { x1: 55, y1: 10, x2: 57, y2: 14 },   // плечі
  { x1: 57, y1: 14, x2: 59, y2: 18 },   // голова-тулуб
  { x1: 59, y1: 18, x2: 61, y2: 22 },   // тулуб-пояс
  { x1: 61, y1: 22, x2: 63, y2: 26 },   // пояс-коліна
  { x1: 63, y1: 26, x2: 65, y2: 30 },   // коліна-стопи
  { x1: 55, y1: 14, x2: 59, y2: 18 },   // ліве плече-тулуб
  { x1: 65, y1: 18, x2: 61, y2: 22 },   // праве плече-пояс
  { x1: 61, y1: 22, x2: 59, y2: 22 },   // пояс (1-2 зірка)
  { x1: 59, y1: 22, x2: 63, y2: 22 },   // пояс (2-3 зірка)
  
  // 3. Кассіопея - W-подібне сузір'я
  { x1: 75, y1: 28, x2: 78, y2: 31 },   // верхня ліва зірка-верхня центральна
  { x1: 78, y1: 31, x2: 82, y2: 33 },   // верхня центральна-верхня права
  { x1: 82, y1: 33, x2: 80, y2: 38 },   // верхня права-нижня права
  { x1: 80, y1: 38, x2: 76, y2: 35 },   // нижня права-нижня центральна
  { x1: 76, y1: 35, x2: 75, y2: 31 },   // нижня центральна-верхня ліва
])
